...
EOF
  ...
  ~/.acme.sh/acme.sh --set-default-ca --server letsencrypt --issue -w /usr/share/nginx/ --cert-home /etc/certs -d $domain -k ec-256 --log --reloadcmd "systemctl restart trojan nginx || true"
